    ...
    <section class="artice-detailes pb-5">
        <div class="container">
            <div class="article-img m-auto">
                <img src="{{$posts->photo}}" class="card-img-top" alt="article-img">
            </div>
            <div class="article-content my-4">
                ...
                <div class="article-details p-4">
                    <p class="my-md-4">{{$posts->contents}}
                    </p>
                </div>
            </div>
        </div>
                    ...
                    <div class="slick-cont">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center"><a href="{{route('details-posts',$post->id)}}" class="btn bg px-5">التفاصيل</a></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
