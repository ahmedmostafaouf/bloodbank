    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">   المحافظات <small style="color:black;">{{$governorates -> count()}}</small></h6>  <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            @if(auth()->user()->haspermission('create_governorates'))
                                <a class="btn btn-primary " href="{{route('governorates.create')}}"><i class="fa fa-plus"></i> أضف</a>
                            @else
                        ...
                        <tr>
                            ...
                            <td>
                                @if(auth()->user()->haspermission('update_governorates'))
                                    <a href="{{route('governorates.edit',$governorate->id)}}"   class="btn btn-primary btn-circle btn-lg"><i class="fas fa-info-circle"></i></a>
                                @else
                                ...
                                <td>
                                    ...
                                    @else
                                        <a class="btn btn-danger btn-circle btn-lg disabled " href=""><i class="fas fa-trash"></i> أضف</a>
                                    @endif
