    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">  اضف مشرف </h6> <br>
                </div>
            </div>
            <div class="box-body">
                ...
                <form action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 " >
                        <div class="form-group">
                            <label for="governorate">كلمه السر </label>
                    ...
                    <div class="col-md-12 " >
                        <div class="form-group">
                            <label for="governorate"> تأكيد كلمه السر </label>
                                    ...
                                    <div class="tab-pane fade show {{$index==0?'active':''}}" id="{{$model}}" role="tabpanel" aria-labelledby="{{$model}}-tab">
                                       <div class="form-group">
                                        @foreach($maps as $index=>$map)
                                                <label class="form-check-label" for="exampleCheck1"><input type="checkbox" class="form-check-inline" id="exampleCheck1" name="permission[]" value="{{ $map.'_'.$model }}"> {{$map}}</label>
                                        @endforeach
                                       </div>
                                    </div>
